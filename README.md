...
*   **MongoDB:** Official MongoDB driver for Node.js for database interactions.
*   **Bcrypt:** Used for hashing passwords and security.
*   **Asynckit:** Minimal async jobs utility library.
...
3.  **Run the Application:**
    ...
    node index.js
    ```
    *(Note: Replace `index.js` with your main entry file if it is named `app.js` or `server.js`)*
